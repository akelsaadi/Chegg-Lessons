public class CedilloHernanMatrix implements Matrix {

	//TODO: implement interface.
	int[][] data;

	
	CedilloHernanMatrix(int[][] data) {
		if(data.length < 1) {
	...
	public Matrix scale(int scalar) {
		...
		Matrix new_matrix = new CedilloHernanMatrix(newData);
		return new_matrix;
	}
	...
	public static void main(String[] args) {
		...
		Matrix m1 = new CedilloHernanMatrix(data1);
		Matrix m2 = new CedilloHernanMatrix(data2);
		Matrix m3 = new CedilloHernanMatrix(data3);
